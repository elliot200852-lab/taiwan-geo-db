...
- 下一批＝**批 7 剩新營・安南**。**David 2026-09-07 拍板：等他明示「繼續」才動工，一次仍只做一區。** 新營＝倒風內海港族第二頁，派工單從 `_workspace/geo-tn-b6/yanshui-acceptance.md` §A3 貼鹽水「港淤之後怎麼收縮」段；安南在西港（批 3）之後、臺鹼安順廠口徑見 §4-B。開工照 §0-TN 步驟 1；共同段沿用 `b7/tn-b7-common.md`（⚠ 目前是楠西版，要換風險條）。
