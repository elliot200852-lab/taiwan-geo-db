...
## 0. 下一個 session 從這裡開始（2026-07-28 上午收官更新）

**一句話**：新北 16 區（含三重）＋宜蘭縣概論**已全部上線**（commit 088f67d，
CI 綠、`verify_live_images.py` 583/583 全綠）。17 篇獨立事實查核全過（4 高 20 中
已修）、17 張 hero 已生已掛、宜蘭 12 篇 33 處 AI 腔已清。**這條線目前沒有欠帳。**

### 下一批（等 David 指示才動工）
剩 13 區：永和、蘆洲、五股、泰山、樹林、土城、深坑、石碇、坪林、三芝、石門、萬里、雙溪。
動工時照 §4 續做 SOP（含紅隊關卡）＋§7 派工模板；查核照本輪模式
（寫作與查核分開派、修正另派、一批收齊才 commit）。
