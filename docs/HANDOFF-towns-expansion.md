...
- 下一批＝**批 8 南化・下營・將軍**（南化＝全批唯一莫拉克頁；下營＝港族第三頁，從 `xinying.md` 與 `yanshui.md` 對照）。**節奏照舊：一次一區，等 David 明示才動工。** 開工照 §0-TN 步驟 1；共同段從 `b7/tn-b7-common-annan.md` 改風險條；fresh 驗收沿用 `b7/tn-b7-accept-common.md`（路徑 b7 要改 b8）。
