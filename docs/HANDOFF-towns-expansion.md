...
- 下一批＝**TN-S2 批 6 左鎮・鹽水・南（3 區平行）**：左鎮在玉井（批 3）與龍崎（批 4）之後（惡地用字照 §4-B 龍崎基準）；鹽水＝倒風內海三港族第一頁（在麻豆總論之後）；南＝二仁溪三頁的第一頁（對照基準頁，仁德批 10、歸仁後批）。開工照 §0-TN 步驟 1（dispatch-preflight → towns_status → 紅隊關卡 §5），派工單新開 `b6/`（共同段從 `b5/tn-b5-common.md` 改回 3 支平行版）。
