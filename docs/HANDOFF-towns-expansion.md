...
## 0. 下一個 session 從這裡開始（2026-08-05 臺北第一批更新）

**一句話（2026-08-05）**：**臺北第一批 4/12 上線（中山、文山、北投、萬華，commit eb20223，
CI 綠、verify_live_images 765/765）**，全站鄉鎮頁 45/45。派工模板已補臺北批分工表與
taipei.md 裝置黑名單（郁永河／同安商人／盆地口白＋五探究題不准重用）；hero 4 張已生
（文山「多畫一座湖」、北投「山頂冒煙」各一修，教訓同大屯山三修：具體地標與地質狀態要目檢）。
臺北剩 8 區：士林、內湖、南港、松山、大同、中正、大安、信義（towns: 欄已預留全 12 區）。
