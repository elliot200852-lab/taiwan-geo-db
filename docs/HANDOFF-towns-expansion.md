...
- 下一批＝**批 6 最後一區「南」**（左鎮 2026-09-08 上線、鹽水同日上線）。**David 2026-09-07 拍板：等他明示「繼續」才動工，一次仍只做一區。** **南＝二仁溪三頁的第一頁（＝該組的對照基準頁），必須在仁德（批 10）之前完成**；污染整治通論一句互指高雄茄萣（§4-B）。開工照 §0-TN 步驟 1（dispatch-preflight → towns_status → 紅隊關卡 §5），派工單沿用 `b6/tn-b6-common.md`（單區序做版，改頁次與該區風險段；⚠ 共同段目前是鹽水版，要改回南區的風險條）。
