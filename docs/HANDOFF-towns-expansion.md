...
- 下一批＝**TN-S2 批 6 剩下的鹽水・南**（左鎮已於 2026-09-08 上線）。**David 2026-09-07 拍板：等他明示「繼續」才動工，一次仍只做一區。** 鹽水＝倒風內海三港族第一頁（麻豆總論已上線）；**南＝二仁溪三頁的第一頁（對照基準頁），必須在仁德（批 10）之前完成**——這是本組唯一的硬排序，跳過左鎮不影響它。開工照 §0-TN 步驟 1（dispatch-preflight → towns_status → 紅隊關卡 §5），派工單沿用 `b6/tn-b6-common.md`（單區序做版，只需改頁次與該區風險段）。
