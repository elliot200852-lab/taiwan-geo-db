...
- 下一批＝**批 7 剩安南**（本輪已授權，新營上線後直接動工）。紅隊＝`_workspace/geo-kh-reviews/tainan-redteam-b7c-20260917.md`；派工單＝`b7/tn-b7-common-annan.md`＋`tn-b7-annan.md`＋`tn-b7-check-annan.md`＋`tn-b7-accept-common.md`。
